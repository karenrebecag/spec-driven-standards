...
| skill | origen | fuente | como obtenerla |
|---|---|---|---|
| `cortex-implementation` | propia | — | /plugin install atom@spec-driven-standards |
| `cortex-reference` | propia | — | /plugin install atom@spec-driven-standards |

## web (9)

| skill | origen | fuente | como obtenerla |
|---|---|---|---|
| `animate-text` | terceros-agents | — | ~/.agents/skills/animate-text |
| `archify` | terceros-mit | — | instalada a mano en ~/.claude/skills |
...
| skill | origen | fuente | como obtenerla |
|---|---|---|---|
| `copywriting` | terceros-agents | — | ~/.agents/skills/copywriting |
| `email-campaigns` | propia | — | /plugin install martech@spec-driven-standards |
| `email-marketing-bible` | terceros-mit | — | instalada a mano en ~/.claude/skills |
| `linkedin-post-writer` | sin-determinar | — | instalada a mano en ~/.claude/skills |
| `resend` | terceros-agents | — | ~/.agents/skills/resend |
| `seo-audit` | terceros-agents | — | ~/.agents/skills/seo-audit |
| `seo-geo` | terceros-agents | — | ~/.agents/skills/seo-geo |
| `ux-copy` | terceros-agents | — | ~/.agents/skills/ux-copy |
...
| skill | origen | fuente | como obtenerla |
|---|---|---|---|
| `power-automate-build` | terceros | — | instalada a mano en ~/.claude/skills |
| `power-automate-debug` | terceros | — | instalada a mano en ~/.claude/skills |
| `power-automate-governance` | terceros | — | instalada a mano en ~/.claude/skills |
| `power-automate-mcp` | terceros | — | instalada a mano en ~/.claude/skills |
| `power-automate-monitoring` | terceros | — | instalada a mano en ~/.claude/skills |

## mac-ops (2)

| skill | origen | fuente | como obtenerla |
|---|---|---|---|
| `clop-compress` | propia | — | /plugin install mac-ops@spec-driven-standards |
| `use-spark` | terceros | — | instalada a mano en ~/.claude/skills |

## office-docs (8)

| skill | origen | fuente | como obtenerla |
|---|---|---|---|
| `docs` | synced-anthropic | — | sync de la cuenta Claude |
| `docx` | synced-anthropic | — | sync de la cuenta Claude |
| `import-memory` | synced-anthropic | — | sync de la cuenta Claude |
| `morning` | synced-anthropic | — | sync de la cuenta Claude |
| `pdf` | synced-anthropic | — | sync de la cuenta Claude |
