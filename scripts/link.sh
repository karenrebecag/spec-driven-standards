...
enlazar "$CLAUDE/skills/discover" "$REPO/plugins/product/skills/discover"
enlazar "$CLAUDE/skills/spec" "$REPO/plugins/product/skills/spec"
enlazar "$CLAUDE/skills/ci" "$REPO/plugins/delivery/skills/ci"
enlazar "$CLAUDE/skills/release" "$REPO/plugins/delivery/skills/release"
enlazar "$CLAUDE/skills/production-readiness" "$REPO/plugins/delivery/skills/production-readiness"
enlazar "$CLAUDE/skills/observe" "$REPO/plugins/reliability/skills/observe"
enlazar "$CLAUDE/skills/incident" "$REPO/plugins/reliability/skills/incident"
enlazar "$CLAUDE/skills/learn" "$REPO/plugins/reliability/skills/learn"
enlazar "$CLAUDE/skills/lean-review" "$REPO/plugins/standards/skills/lean-review"
enlazar "$CLAUDE/skills/api-design-patterns" "$REPO/plugins/standards/skills/api-design-patterns"
enlazar "$CLAUDE/skills/git-advanced" "$REPO/plugins/standards/skills/git-advanced"
enlazar "$CLAUDE/skills/security-hardening" "$REPO/plugins/security/skills/security-hardening"
enlazar "$CLAUDE/skills/security-audit-deep" "$REPO/plugins/security/skills/security-audit-deep"
enlazar "$CLAUDE/skills/performance-optimization" "$REPO/plugins/reliability/skills/performance-optimization"
